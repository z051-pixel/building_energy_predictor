...
def load_model():
    ...
    with open("building_pipeline_app1.1.2.pkl", "rb") as f:        
        model = pickle.load(f)
    return model
...
#cd "/Users/mac/Downloads/Building Energy/Building Energy Predictor"
#streamlit run building_energy_app1.1.2.py